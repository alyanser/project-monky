...
void CInstallManager::InitSequencer()
{
    ...
    SString strSource = CR "initial: "                                                     // *** Starts here  by default
        ...
        // 2. core.dll launches "Project Monky.exe install_stage=crashed" (bypasses mutex)
...
{
    MessageBoxUTF8(0, SString(_("Project Monky has been cursed. It is highly recommended that you restart your PC and try again. %s"), *strExtraInfo), _("Error") + _E("CL03"),
